...
def create_app():
    ...
    # Config - Use production config if FLASK_ENV is production
    ...
    def api_root():
        return {"message": "Contact Manager API", "status": "running", "endpoints": ["/api/health", "/api/auth/register", "/api/auth/login", "/api/contacts"]}
    ...
    def test():
        return {"message": "Backend is working!", "database": "Neon PostgreSQL", "status": "connected"}
